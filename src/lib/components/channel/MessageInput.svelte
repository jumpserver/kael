				...
				{:else}
					...
					>
						<div
							...
							class="flex-1 flex flex-col relative shadow-lg rounded-3xl border border-gray-50 dark:border-gray-850 hover:border-gray-100 focus-within:border-gray-100 hover:dark:border-gray-800 focus-within:dark:border-gray-800 transition px-1 bg-white/90 dark:bg-gray-400/5 dark:text-gray-100 mx-auto max-w-4xl"
										...
										{#if acceptFiles}
											...
											>
												<button
													...
													class="bg-transparent hover:bg-white/80 text-gray-800 dark:text-white dark:hover:bg-gray-700 transition rounded-full p-1.5 outline-hidden focus:outline-hidden"
													type="button"
													aria-label="More"
												>
													<svg
